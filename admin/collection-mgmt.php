...
<head>
    ...
    <title>Collection Management - DesiVastra Admin</title>
...
<div class="page-content">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="subtitle">Create and manage curated product collections and lookbooks.</p>
        </div>
    </div>

    <div class="card" style="text-align:center; padding: 80px 40px;">
        <i class="fas fa-layer-group" style="font-size:64px; color:var(--gold-primary); opacity:0.6; display:block; margin-bottom:24px;"></i>
        <h2 style="font-size:24px; font-weight:700; color:var(--text-primary); margin-bottom:12px;">Collection Management</h2>
        <p style="color:var(--text-muted); font-size:14px; max-width:400px; margin:0 auto 28px;">Create and manage curated product collections and lookbooks.</p>
