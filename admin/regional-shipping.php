...
<head>
    ...
    <title>Regional Shipping - DesiVastra Admin</title>
...
<div class="page-content">
    ...
    <div class="page-header">
        <div>
            ...
            <h1>Regional Shipping</h1>
            <p class="subtitle">Configure region-specific shipping rules and rates.</p>
        </div>
    </div>

    <div class="card" style="text-align:center; padding: 80px 40px;">
        <i class="fas fa-map-marked-alt" style="font-size:64px; color:var(--gold-primary); opacity:0.6; display:block; margin-bottom:24px;"></i>
        <h2 style="font-size:24px; font-weight:700; color:var(--text-primary); margin-bottom:12px;">Regional Shipping</h2>
        <p style="color:var(--text-muted); font-size:14px; max-width:400px; margin:0 auto 28px;">Configure region-specific shipping rules and rates.</p>
