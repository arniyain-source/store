...
<head>
    ...
    <title>FAQ Manager - DesiVastra Admin</title>
...
<div class="page-content">
    ...
    <div class="page-header">
        <div>
            ...
            <h1>FAQ Manager</h1>
            <p class="subtitle">Create and organize frequently asked questions for your customers.</p>
        </div>
    </div>

    <div class="card" style="text-align:center; padding: 80px 40px;">
        <i class="fas fa-question-circle" style="font-size:64px; color:var(--gold-primary); opacity:0.6; display:block; margin-bottom:24px;"></i>
        <h2 style="font-size:24px; font-weight:700; color:var(--text-primary); margin-bottom:12px;">FAQ Manager</h2>
        <p style="color:var(--text-muted); font-size:14px; max-width:400px; margin:0 auto 28px;">Create and organize frequently asked questions for your customers.</p>
